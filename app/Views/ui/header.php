  ...
  <header class="pc-header">
    <div class="m-header">
      <a href="<?php echo site_url('ref') ?>" class="b-brand text-primary align-items-center" style="padding-top: 10px;">
        ...
        <!-- <img src="<?php echo base_url('assets/images/logo-white.svg') ?>" alt="logo image" class="logo-lg" /> -->
        <h2 style="color:white;">SMARTERP</h2>
      </a>
    </div>
    <div class="header-wrapper" style="padding:0 0px;"> <!-- [Mobile Media Block] start -->
