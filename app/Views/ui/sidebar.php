...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        <?php echo $ref; ?>
        <a href="javascript:void(0)" class="pc-link"><span class="pc-micon" style="pointer-events: auto !important; cursor: pointer; position: relative; z-index: 10;" onclick="event.preventDefault(); event.stopPropagation(); window.location.href='<?php echo site_url('ref'); ?>';"><i class="ph ph-clipboard"></i></span><span class="pc-mtext" style="pointer-events: auto !important; cursor: pointer; position: relative; z-index: 10;" onclick="event.preventDefault(); event.stopPropagation(); window.location.href='<?php echo site_url('ref'); ?>';">Referensi</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
        <ul class="pc-submenu">
          <?php echo $kod_rek; ?>
